...
app.post("/api/link/verify", async (req, res) => {
  try {
    ...
    res.json({
      success: true,
      minecraftUsername: linkCode.minecraft_username,
      minecraftUuid: linkCode.minecraft_uuid
    });
...
// Get Discord/Minecraft link information
...
app.listen(PORT, "0.0.0.0", () => {
  console.log(`Aster MC Link API running on port ${PORT}`);
});